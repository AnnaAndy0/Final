...
const checkoutItems = ()=>{
  return (
    <div>
      <Badge style={{ width: 200, padding: 10, marginLeft:"25px"}} color="light">
        <h5 style={{ fontWeight: 100, color: "gray" }}>Total:</h5>
        <h3>${cart.total}</h3>
      </Badge>
          <Link href="/checkout/">
            <Button style={{ width: "60%", padding: "", marginLeft: "50px"}} color="danger">
              <a>Order</a>
            </Button>
          </Link>
    </div>
  ...
  return (
    <div>
      ...
      <Card style={{ padding: "10px 5px" }} className="cart">
        <CardTitle style={{ margin: 5 }}>Your Order:</CardTitle>
        <hr />
